    ...
    <>
      <section className="hero">
        <div className={`hero-content ${isLoaded ? 'loaded' : ''}`}>
          ...
          <div className="social-section fade-in-up delay-3">
          ...
          <div id="contact" className="contact-section fade-in-up delay-4">
            <h2 className="section-title">Contact</h2>
            <p className="contact-text">
              You can reach me out anytime at{' '}
              <a href="mailto:oluwadamilarebabatunde39@gmail.com" className="contact-email">
